![image](https://user-images.githubusercontent.com/45786659/118906839-7882d480-b959-11eb-8228-37227686ab9d.png)
...
1. 결제가 완료되면, 결제 & 예약 내용을 게스트에게 알림을 전송한다. (Async, 알림서비스)
1. 예약 내역을 호스트에게 전달한다.
1. 게스트는 본인의 예약 내용 및 상태를 조회한다.
1. 게스트는 본인의 예약을 취소할 수 있다.
1. 호스트는 게스트들의 예약 내용 및 상태를 조회한다.
1. 호스트는 게스트의 예약을 취소 할 수 있다.
1. 예약이 취소되면, 결제를 취소한다. (Async, 결제서비스)
1. 결제가 취소되면, 결제 취소 내용을 게스트에게 알림을 전송한다. (Async, 알림서비스)
